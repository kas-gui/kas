...
cargo check --example calculator --example clock --example counter --example cursors --example data-list --example hello --example layout --example splitter --example stopwatch \
