...
mod RadioBox {
    ...
    pub struct RadioBox<A> {
        ...
        on_select: Option<Box<dyn Fn(&mut EventCx, &A) + Send>>,
    }
    ...
    impl Self {
        ...
        #[inline]
        #[must_use]
        pub fn with(mut self, f: impl Fn(&mut EventCx, &A) + Send + 'static) -> Self {
...
mod RadioButton {
    ...
    impl Self {
        ...
        #[inline]
        #[must_use]
        pub fn with(self, f: impl Fn(&mut EventCx, &A) + Send + 'static) -> Self {
            RadioButton {
                core: self.core,
