...
@vertex 
fn main(@location(0) a_pos: vec2<f32>, @location(1) a_col: vec4<f32>, @location(2) a1_: f32, @location(3) a2_: vec2<f32>, @location(4) a3_: vec2<f32>) -> VertexOutput {
    a_pos_1 = a_pos;
    a_col_1 = a_col;
    a1_1 = a1_;
    a2_1 = a2_;
